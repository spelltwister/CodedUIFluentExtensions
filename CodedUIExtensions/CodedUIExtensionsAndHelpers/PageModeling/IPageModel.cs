namespace CodedUIExtensionsAndHelpers.PageModeling
{
    ...
    {
        /// <summary>
        /// Returns true if the model can be found, but it does not
        /// have to be visible or otherwise able to be interacted with
        /// </summary>
        /// <param name="wait">
        ...
        /// <summary>
        /// Returns true if the model cannot be found
        /// </summary>
        /// <param name="wait">
        ...
        /// </returns>
        /// <remarks>
        /// This will return true if the element is visible, but not
        /// necessarily in view (may not actually be able to see it
        /// due to being off screen or blocked).
        /// </remarks>
