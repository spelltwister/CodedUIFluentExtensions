...
{
    public abstract class TextControlPageModelWrapperBase<TUIType, TValue, TNextModel> : HasNextModelUIControlPageModelWrapperBase<TUIType, TNextModel>, ITextValueablePageModel<TValue, TNextModel>
        ...
        where TNextModel : IPageModel
    {
        ...
        protected TextControlPageModelWrapperBase(TUIType control, TNextModel nextModel, Func<string, TValue> stringToValueFunc, Func<TValue, string> valueToStringFunc) : base(control, nextModel)
        {
