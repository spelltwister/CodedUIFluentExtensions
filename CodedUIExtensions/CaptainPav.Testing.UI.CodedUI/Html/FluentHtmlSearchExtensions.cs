...
namespace CaptainPav.Testing.UI.CodedUI.Html
{
    ...
    {
        public static T Find<T>(this HtmlControl control, string idValue) where T : HtmlControl, new()
        {
            return control.Find<T>(HtmlControl.PropertyNames.Id, idValue, PropertyExpressionOperator.EqualTo);
        }
