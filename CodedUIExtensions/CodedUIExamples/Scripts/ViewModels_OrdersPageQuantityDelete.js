...
var OrdersViewModel = (function () {
    function OrdersViewModel(initialValue) {
        ...
        this.quantity = ko.observable(initialValue && initialValue.quantity);
        this.isCompleteOrder = ko.pureComputed(function () { return _this.orderId() && _this.name() && _this.quantity() > 0 && _this.price() > 0; });
        this.orders = OrderDataStore.instance.orders;
        this.isNewOrderVisible = ko.observable(false);
    }
    OrdersViewModel.prototype.save = function () {
        OrderDataStore.instance.orders.push({ orderId: this.orderId(), name: this.name(), quantity: this.quantity(), price: this.price() });
        this.orderId(null);
        this.name(null);
        this.quantity(null);
        this.price(null);
    };
    OrdersViewModel.prototype.newOrder = function () {
        this.orderId(null);
        this.name(null);
        this.quantity(null);
        this.price(null);
    ...
    OrdersViewModel.prototype.cancelNewOrder = function () {
...
var AppViewModel = (function () {
    ...
    AppViewModel.prototype.saveAccountSettings = function () {
        ...
        this.currentUser(UserDataStore.instance.findByUsername(this.accountSettingsVM.username).settings);
    };
