...
namespace CaptainPav.Testing.UI.CodedUI.PageModeling.Win.Office2013
{
    public class OutlookSavePendingChangesAlert<T> : PageModelBase<WinWindow>
    {
        ...
        internal protected override WinWindow Me => new WinWindow().Extend(WinWindow.PropertyNames.Name, EmailWindowName, PropertyExpressionOperator.EqualTo);

	    protected WinButton YesButton => this.Me.Find<WinButton>(WinButton.PropertyNames.Name, "Yes", PropertyExpressionOperator.EqualTo);

	    protected WinButton NoButton => this.Me.Find<WinButton>(WinButton.PropertyNames.Name, "No", PropertyExpressionOperator.EqualTo);

	    protected WinButton CancelButton => this.Me.Find<WinButton>(WinButton.PropertyNames.Name, "Cancel", PropertyExpressionOperator.EqualTo);
        ...
        public T ClickNo()
        {
            ...
            return this._nextModel.NextModel;
        }
        /// <summary>
